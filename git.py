...
# git init ==> to start git (nanti ada file hidden 'git
# git status ==> untuk cek status

# ++++++ untuk langkah save dengan git ++++++++
# git add . === > untuk semua file
# git add (filename) ===> jika mau file tertentu
# git commit -m ('nama lable') ====> untuk memberi label
...
# ===========================================================================
#
# ++++++langkah untuk upload ke web github +++++++
